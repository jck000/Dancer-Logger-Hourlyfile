...
MAKE = make
FULLEXT = Dancer/Logger/Hourlyfile
BASEEXT = Hourlyfile
PARENT_NAME = Dancer::Logger
DLBASE = $(BASEEXT)
...
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Dancer/Logger
...
DISTVNAME = Dancer-Logger-Hourlyfile-0.02
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "Dancer-Logger-Hourlyfile",' >> META_new.json
